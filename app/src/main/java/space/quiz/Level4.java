...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewOfLevel.setText(R.string.level4);
        ...
        preview_img.setImageResource(R.drawable.preview_img_4);

        //установка фона диалогового окна
        LinearLayout dialogFon = dialog.findViewById(R.id.dialogFon);
        dialogFon.setBackgroundResource(R.drawable.preview_background4);
        ...
        dialogFonEnd.setBackgroundResource(R.drawable.preview_background4);

        //интересный факт
        TextView texDescriptionEnd = dialogEnd.findViewById(R.id.text_description_end);
        texDescriptionEnd.setText(R.string.level_four_end);
        ...
        //конец кода диалового окна в конце уровня
